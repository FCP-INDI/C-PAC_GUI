export const build = (pipeline, environment) => ```
...
workingDirectory :  ${environment.working_dir}


# Directory where CPAC should write crash logs.
crashLogDirectory :  ${environment.crash_dir}


# Directory where CPAC should place run logs.
logDirectory :  ${environment.log_dir}
...
generateQualityControlImages :  [${pipeline.configuration.general.quality_control}]
...
already_skullstripped :  [${pipeline.configuration.anatomical.enabled ? 0 : 1}]


# Choice of using AFNI or FSL-BET to perform SkullStripping
skullstrip_option :
  ${pipeline.configuration.anatomical.skull_stripping.methods.afni.enabled ? "- AFNI" : ""}
  ${pipeline.configuration.anatomical.skull_stripping.methods.bet.enabled ? "- BET" : ""}
