...
const mapStateToProps = (state) => ({
  pipelines: state.main.getIn(['config', 'executions']),
})

const mapDispatchToProps = {
}

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(ExecutionList.styles)(ExecutionList)))
