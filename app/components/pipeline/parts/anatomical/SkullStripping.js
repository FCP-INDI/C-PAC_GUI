    ...
    return (
      <Grid container spacing={8}>
        ...
        <Grid item lg={6} xs={12} style={{ padding: 20 }}>
          ...
          <Typography paragraph>- AFNI’s 3dSkullStrip</Typography>
          <Typography paragraph>- FSL’s BET, and can configure further parameters for each of these tools.</Typography>
          <Typography paragraph>- Providing their own brain mask for extraction</Typography>
        </Grid>
      </Grid>
    )
  }
